...
return (<div> <br/> <br/> <br/>    
            <div className="container mx-20">
                ...
                <div className="mt-8">
                    <h3 className=" text-2xl font-bold bg-gradient-to-r from-red-700 via-red-500 to-red-700 bg-clip-text text-transparent animate-moveGradient ">Why Choose MoviePicks?</h3>
